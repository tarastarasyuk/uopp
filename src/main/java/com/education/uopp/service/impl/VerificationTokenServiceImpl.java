...
public class VerificationTokenServiceImpl implements VerificationTokenService {
    ...
    public String validateVerificationToken(String token) {
        ...
        if (verificationToken.getConfirmedAt() != null) {
            throw new TokenValidationException("Email is already confirmed");
        }
        ...
        studentRepository.enableStudent(student.getEmail());
        return "confirmed";
    }
    ...
    @Override
    public String getTokenForStudent(Student student) {
        return verificationTokenRepository.findVerificationTokenByStudent(student).get().getToken();
    }

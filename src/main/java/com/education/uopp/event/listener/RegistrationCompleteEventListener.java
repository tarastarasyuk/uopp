package com.education.uopp.event.listener;

import com.education.uopp.email.EmailSender;
...
public class RegistrationCompleteEventListener implements ApplicationListener<RegistrationCompleteEvent> {
    ...
    public void onApplicationEvent(RegistrationCompleteEvent event) {
        ...
        if (user.getRole().equals(Role.ROLE_STUDENT)) {
            Student student = studentService.findStudentByEmail(user.getEmail()).get();

            emailSender.send(student.getEmail(),
                    buildEmail(String.join(" ", student.getFirstName(), student.getLastName()), url));

            log.info("Hello " + student.getFirstName() + " " + student.getLastName());
